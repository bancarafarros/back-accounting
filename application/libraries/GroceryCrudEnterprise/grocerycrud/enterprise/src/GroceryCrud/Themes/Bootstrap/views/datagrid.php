<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grid' . $minify_or_not . '.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.4.8b248bf' . $minify_or_not . '.js');
