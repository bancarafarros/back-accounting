...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h3>LAPORAN PEMBELIAN PER PEMASOK (DETAIL)</h3></center><br/></td>
</tr>
...
<table border="0" align="center" style="width:900px;border:none;">
        <tr>
            <td style="text-align:left;width:8%">Pemasok: </td><td style="text-align:left;width:92%">:<?php echo " ".$b['namapemasok'];?></td>
        </tr>
        <tr>
            <td style="text-align:left;width:8%">Alamat: </td><td style="text-align:left;width:92%">:<?php echo " ".$b['alamatp'];?></td>
        </tr>
        <tr>
...
<?php
  ...
  foreach($data->result_array()as $d){
    ...
    if($group=='-' || $group!=$d['n_pembelian']){
        ...
        $this->db->select('hpembelian.*, dpembelian.disc as diskon, dpembelian.harga as harganya,dpembelian.harga_asli as hargaasli, dpembelian.jumlah as jumlahnya, barang.nama as nama_barang');
        ...
        $this->db->where('hpembelian.n_pembelian = "$npembelian"');
        $this->db->order_by('n_pembelian', 'desc');
        $data = $this->db->get();

     if($group!='-')
        echo "</table><br>";
        echo "<table align='center' width='900px;' border='1'>";
        echo "<tr><td colspan='8' style='text-align:center;'><b>No.".' '."$npembelian</b></td></tr>";
        echo "<tr><td><b>Tanggal</b></td> <td colspan='5' style='text-align:left;'>".': '."$tanggal_beli</td><td style='text-align:right;'><b>Total:</b></td><td style='text-align:right;'><b>".'Rp '.$total."</b></td></tr>";
