...
<?php
    ...
    $conv_date = strtotime($param['bulan']);
    $bulan = date('F Y',$conv_date);

    $b=$perusahaan->row_array();
?>
<table border="0" align="center" style="width:600px; border:none;margin-top:5px;margin-bottom:20px;">
    <tr>
        <th style="width:600px;"><center>LAPORAN RUGI LABA BULANAN</center></th>
    </tr>
    <tr>
        <th style="width:600px;"><center><?php echo $b['nama'];?></center></th>
    </tr>
    <tr>
        <th style="width:600px;"><center>Bulan <?php echo " ".$bulan;?></center></th>
    </tr>                    
</table>
...
<table align="center" style="width:600px; border:none;margin-top:5px;margin-bottom:20px;">
   <tr style="border-bottom: 1px solid;">
        <td colspan="3" style="text-align:right;"><b>Total Laba Bulan ini</b></td>
