...
?>
<head>
    <title><?php echo $b['n_rpenjualan'];?></title>
    <meta charset="utf-8">
...
<table border="0" align="center" style="width:700px;border:none;">
    <tr>
        ...
        <td colspan="1" style="width:800px;paddin-left:20px; padding-top:5px;" align="right"><h1># NOTA RETUR PENJUALAN</h1><br/></td>
    </tr>
</table>
<table border="0" align="center" style="width:700px;border:none;">
        <tr>
            <th width="25%" style="text-align:left;"><b>Nomor Transaksi</b></th>
            <td style="text-align:left;">: <?php echo $b['n_rpenjualan'];?></td>
            <th style="text-align:left;">Pelanggan</th>
            <td style="text-align:left;">: <?php echo $b['namapelanggan'];?></td>
        </tr>
        <tr>
...
<tfoot>
    <tr>
        ...
        <td style="text-align:right;"><b><?php echo 'Rp '.number_format($b['total_penjualan']);?></b></td>
    </tr>
</tfoot>
</table>
<table align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:20px;">
    ...
    <tr>
        ...
        $totalAll = $b['biaya_kirim'] + $b['ppn'] + $b['total_penjualan'];
    ...
    <tr>
        ...
        <td style="text-align:right; padding-right:5px; border-top:1px dashed;"><?php echo 'Rp. '.number_format(@$b['piutang']);?>
        </td>
    </tr>
   <tr>
