        ...
        <div id="laporan">
            ...
            <table border="0" align="center" style="width:100%;border:none; border-top:1px dashed;">
                ...
                <tr>
                    ...
                    <th width="15%" style="text-align:left;" class="text-medium"><b>Nama Pemasok</b></th>
                    <td width="25%" style="text-align:left;" class="text-medium">: <?= $data['namapemasok'] ?></td>
                </tr>
                <tr>
            ...
            <table border="1" rules="all" class="mt-3" align="center" style="width:100%;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align:right;"><b><?= currencyIDR($data['total_pembelian']) ?></b></td>
                    </tr>
                </tfoot>
            </table>
            <table align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:20px;">
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-top:1px dashed; padding-right:5px;">
                        <?php
                        $totalAll = $data['biaya_kirim'] + $data['ppn'] + $data['total_pembelian'];
                ...
                <tr>
                    ...
                    <td style="text-align:right; padding-right:5px; border-top:1px dashed;"><?php echo currencyIDR($data['hutang']); ?>
                    </td>
                </tr>
            </table>
        </div>
