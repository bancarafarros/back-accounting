		...
		<div class="card">
			<div class="card-body">
				<div class="media align-items-center">
					...
					<div class="m-l-15">
						<h2 class="m-b-0"><?= currencyIDR($tot_kasmasuk) ?></h2>
						<p class="m-b-0 text-muted">Kas Masuk</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
				<div class="media align-items-center">
					...
					<div class="m-l-15">
						<h2 class="m-b-0"><?= currencyIDR($tot_kaskeluar) ?></h2>
						<p class="m-b-0 text-muted">Kas Keluar</p>
					</div>
				</div>
			</div>
		</div>
