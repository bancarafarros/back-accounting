...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + 'report/bukubesar/pdf_bukubantuall?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
...
function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/bukubesar/bukubantuall_data',
        type: "POST",
        data: {
