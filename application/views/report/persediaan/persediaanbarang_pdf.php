...
<body>
    ...
    <div class="mt-0">
        <div style="text-align:center;">
            <h4 class="font-weight-bolder text-bold text-uppercase">LAPORAN PERSEDIAAN BARANG</h4>
            ...
            <table border="1" align="center" style="width:650px;margin-bottom:20px;">
                ...
                foreach ($result as $d) {
                    ...
                    if ($group == '-' || $group != $d['n_barang']) {
                        $this->db->select('barang.*, nama, stock_gudang,n_unit, harga_pokok', 'keluar_masuk.tanggal as tanggal');
    ...
    <td width='30%' align='center'>Subtotal</td>
