...
function carifilter() {
    ...
    $('#link-cetak').attr('href', site_url + '/report/persediaan/pdf_persediaanbarangdepartement?tglawal=' + tanggal_awal + '&tglakhir=' + tanggal_akhir);
    loadReport(tanggal_awal, tanggal_akhir);
}

function loadReport(tanggal_awal, tanggal_akhir) {
    $.ajax({
        url: site_url + '/report/persediaan/persediaan_barang_departement_data',
        type: "POST",
        data: {
