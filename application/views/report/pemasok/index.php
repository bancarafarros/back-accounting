            ...
            <table class="table table-hover" width="100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?= site_url('report/pemasok/daftar_pemasok') ?>"><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?= site_url('report/pemasok/hutang_global') ?>"><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">3</th>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?= site_url('report/pemasok/hutang_detail') ?>"><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <!-- <tr>
                        <th scope="row">4</th>
                        <td style="vertical-align:middle;">Laporan Hutang Lunas</td>
                        <td>
                            <a class="btn btn-sm btn-success" href=""><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">5</th>
                        <td style="vertical-align:middle;">Laporan Pembayaran Hutang</td>
                        <td>
                            <a class="btn btn-sm btn-success" href=""><span class="fa fa-search"></span> Lihat</a>
                        </td>
                    </tr> -->
