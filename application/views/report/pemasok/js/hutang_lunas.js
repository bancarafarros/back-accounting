...
function carifilter(){
    ...
    $('#link-cetak').attr('href', site_url + 'report/pemasok/hutang_lunas_pdf?tgl_awal=' + tanggal_awal + '&tgl_akhir=' + tanggal_akhir);
    loadReport(tanggal_awal, tanggal_akhir);
}

function loadReport(tanggal_awal, tanggal_akhir){
    $.ajax({
        url: site_url + "/report/pemasok/hutang_lunas_data",
        type: "POST",
        data: {
