...
<tr>
    <td colspan="2" style="width:700px;paddin-left:20px;"><center><h4>LAPORAN BANK MASUK</h4></center><br/></td>
</tr>
...
$nomor=1;
    ...
    <tr>
        ...
        <td style="text-align:right;" style=""><?php echo number_format($d['kredit_kasbank']);?></td>
    </tr>
<?php
}
?>
