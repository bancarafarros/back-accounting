...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PENJUALAN HARIAN</h4></center><br/></td>
</tr>
  ...
  foreach($data->result_array()as $d){
    ...
    if($group=='-' || $group!=$d['n_penjualan']){
     ...
     if($group!='-')
        ...
        echo "<tr><td><b>Nota</b></td><td colspan='5' style='text-align:left;'>".': '."<b>$npenjualan</b></td><td style='text-align:right;'><b>Tanggal</b></td><td style='text-align:left;'>".': '."$tanggal_jual</td></tr>";
        echo "<tr>
        ...
        echo "<tr><td><b>Sales</b></td> <td colspan='5' style='text-align:left;'>".': '."$sales</td><td style='text-align:right;'><b>Total</b></td><td style='text-align:right;'><b>".'Rp '.$total."</b></td></tr>";
echo "<tr style='background-color:#ccc;'>
    ...
    <td width='11%' align='center'>Harga Jual</td>
