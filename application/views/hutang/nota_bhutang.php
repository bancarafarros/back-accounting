...
<body>
    ...
    $jenis = getJenisTransaksiAccounting(substr($data['n_hutang'], 0, 2));
    ?>
    <div class="mt-0">
        ...
        <div id="laporan">
            ...
            <table border="0" align="center" style="width:100%;border:none; border-top:1px dashed;">
                <tr>
                    ...
                    <td width="40%" style="text-align:left;" class="text-medium">: <?= $jenis ?> <small>(<?= $data['n_hutang'] ?>)</small></td>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:left;"><?= $i['n_beli'] ?></td>
                            <td style="text-align:left;"><?= $i['ketrHutang'] ?></td>
