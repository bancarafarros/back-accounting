<form action="<?= site_url('Pelanggan/dosave') ?>" method="POST">
    ...
    <input type="text" name="n_pelanggan" value="<?= @$detail->n_pelanggan ?>" id=""><br>
    <label for="">Barcode :</label>
    <input type="text" name="barcode" value="<?= @$detail->barcode ?>" id=""><br>
    <label for="">Pass :</label>
    <input type="text" name="pass" value="<?= @$detail->pass ?>" id=""><br>
